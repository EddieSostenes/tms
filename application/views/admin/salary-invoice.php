  ...
  <div class="content-wrapper">
    ...
    <section class="invoice" id="invoice">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          ...
          <address>
            ...
            Manjeri<br>
            Malappuram<br>
            Website: www.officemanagementsystem.info<br>
            Email: admin@officemanagementsystem.info
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>Tzs. <?php echo $cnt['basic_salary']; ?></td>
                <td>Tzs. <?php echo $cnt['allowance']; ?></td>
                <td>Tzs. <?php echo $cnt['total']; ?></td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-6">
          <p class="lead">Amount Due 30/12/2024</p>
